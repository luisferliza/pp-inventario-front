...
import { ProyeccionEdicionComponent } from './proyeccion-edicion/proyeccion-edicion.component';

@Component({
  selector: 'elastic-proyeccion',
  templateUrl: './proyeccion.component.html',
  styleUrls: ['./proyeccion.component.scss'],
  animations: [...ROUTE_TRANSITION],
  host: { '[@routeTransition]': '' }
})
export class ProyeccionComponent implements List<Articulo>, OnInit, OnDestroy {
  ...
  @Input()
  columns: ListColumn[] = [
    { name: 'ID_Proyeccion', property: 'p1', visible: false, isModelProperty: true },
    { name: 'Inversion', property: 'p2', visible: true, isModelProperty: true },
    { name: 'Interes generado', property: 'p3', visible: true, isModelProperty: true },    
    { name: 'Fecha de creacion', property: 'p4', visible: true, isModelProperty: true },
    { name: 'Monto total', property: 'p5', visible: true, isModelProperty: true },
    { name: 'Comentario', property: 'p6', visible: true, isModelProperty: true },    
  ...
  crear() {        
    this.dialog.open(ProyeccionEdicionComponent).afterClosed().subscribe((articulo: Articulo) => {
      if (articulo) {
        this.listar();
  ...
  modificar(estado) {    
    this.dialog.open(ProyeccionEdicionComponent, {
      data: estado
